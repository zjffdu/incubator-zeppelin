...
public class NotebookRepoAsyncTest {
  ...
  private static final Logger LOG = LoggerFactory.getLogger(NotebookRepoAsyncTest.class);
  ...
  public void setUp() throws Exception {
    ...
    System.setProperty(ConfVars.ZEPPELIN_NOTEBOOK_REPO_ASYNC.getVarName(), "true");
