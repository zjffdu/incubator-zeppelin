...
public class EMRFlinkInterpreterLauncher extends EMRStandardInterpreterLauncher {

  public EMRFlinkInterpreterLauncher(ZeppelinConfiguration zConf, RecoveryStorage recoveryStorage) {
