...
public class SparkSqlInterpreter extends Interpreter {
  ...
  public void open() throws InterpreterException {
    ...
    sparkInterpreter = getSpark2Interpreter();
    this.sc = sparkInterpreter.getSparkContext();
    this.sqlContext = sparkInterpreter.getSqlContext();
  }

  private SparkInterpreter getSpark2Interpreter() throws InterpreterException {
  ...
  public InterpreterResult interpret(String st, InterpreterContext context)
    ...
    try {
      ...
      Method sqlMethod = sqlContext.getClass().getMethod("sql", String.class);
      rdd = sqlMethod.invoke(sqlContext, st);
  ...
  public void cancel(InterpreterContext context) throws InterpreterException {
    SparkInterpreter sparkInterpreter = getSpark2Interpreter();
