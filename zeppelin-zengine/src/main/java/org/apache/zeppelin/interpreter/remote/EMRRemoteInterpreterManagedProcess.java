 ...
 */
public class EMRRemoteInterpreterManagedProcess extends RemoteInterpreterProcess {
  private static final Logger LOGGER = LoggerFactory.getLogger(
      EMRRemoteInterpreterManagedProcess.class);
  ...
  public EMRRemoteInterpreterManagedProcess(
      String intpRunner,
