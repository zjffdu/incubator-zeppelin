...
class IPythonStub(object):
  ...
  def __init__(self, channel):
    ...
    self.complete = channel.unary_unary(
        ...
        request_serializer=ipython__pb2.CompleteRequest.SerializeToString,
        response_deserializer=ipython__pb2.CompleteResponse.FromString,
        )
...
def add_IPythonServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'complete': grpc.unary_unary_rpc_method_handler(
          servicer.complete,
          request_deserializer=ipython__pb2.CompleteRequest.FromString,
          response_serializer=ipython__pb2.CompleteResponse.SerializeToString,
      ),
