...
public class RemoteInterpreterEventService {
  ...
  public interface Iface {
    ...
    public void updateParagraphConfig(String noteId, String paragraphId, Map<String,String> config) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void updateParagraphConfig(String noteId, String paragraphId, Map<String,String> config, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_updateParagraphConfig(String noteId, String paragraphId, Map<String,String> config) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class updateParagraphConfig_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public updateParagraphConfig_call(String noteId, String paragraphId, Map<String,String> config, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.noteId = noteId;
        this.paragraphId = paragraphId;
        this.config = config;
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class updateParagraphConfig<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, updateParagraphConfig_args, Void> {
      ...
      public void start(I iface, updateParagraphConfig_args args, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws TException {
...
;
  ...
  public static class updateParagraphConfig_args implements org.apache.thrift.TBase<updateParagraphConfig_args, updateParagraphConfig_args._Fields>, java.io.Serializable, Cloneable, Comparable<updateParagraphConfig_args>   {
    ...
    public String noteId; // required
    public String paragraphId; // required
    public Map<String,String> config; // required
    ...
    public updateParagraphConfig_args setConfig(Map<String,String> config) {
      this.config = config;
      return this;
    }
    ...
    private static class updateParagraphConfig_argsStandardScheme extends StandardScheme<updateParagraphConfig_args> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
                {
                  ...
                  struct.config = new HashMap<String,String>(2*_map34.size);
                  String _key35;
                  String _val36;
                  for (int _i37 = 0; _i37 < _map34.size; ++_i37)
                  {
                    ...
                    struct.config.put(_key35, _val36);
                  }
                  iprot.readMapEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, updateParagraphConfig_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.config != null) {
          oprot.writeFieldBegin(CONFIG_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter38 : struct.config.entrySet())
            {
    ...
    private static class updateParagraphConfig_argsTupleScheme extends TupleScheme<updateParagraphConfig_args> {
        ...
        if (struct.isSetConfig()) {
          {
            ...
            for (Map.Entry<String, String> _iter39 : struct.config.entrySet())
            {
        ...
        if (incoming.get(2)) {
          {
            ...
            struct.config = new HashMap<String,String>(2*_map40.size);
            String _key41;
            String _val42;
            for (int _i43 = 0; _i43 < _map40.size; ++_i43)
            {
              ...
              struct.config.put(_key41, _val42);
            }
          }
          struct.setConfigIsSet(true);
        }
...
;
    ...
    private static class updateParagraphConfig_resultStandardScheme extends StandardScheme<updateParagraphConfig_result> {
    ...
    private static class updateParagraphConfig_resultTupleScheme extends TupleScheme<updateParagraphConfig_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<ParagraphInfo>(_list52.size);
                  ParagraphInfo _elem53;
                  for (int _i54 = 0; _i54 < _list52.size; ++_i54)
                  {
                    _elem53 = new ParagraphInfo();
                    _elem53.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getParagraphList_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (ParagraphInfo _iter55 : struct.success)
            {
              _iter55.write(oprot);
            }
            oprot.writeListEnd();
    ...
    private static class getParagraphList_resultTupleScheme extends TupleScheme<getParagraphList_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getParagraphList_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (ParagraphInfo _iter56 : struct.success)
            {
              _iter56.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<ParagraphInfo>(_list57.size);
            ParagraphInfo _elem58;
            for (int _i59 = 0; _i59 < _list57.size; ++_i59)
            {
              _elem58 = new ParagraphInfo();
              _elem58.read(iprot);
