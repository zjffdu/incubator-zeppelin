...
trait TcpDsSchema extends Schema {
  ...
  def getFieldTypes: Array[InternalType] =
    columns.map(column => column.internalType)
...
object CatalogSales extends TcpDsSchema {
...
object CatalogReturns extends TcpDsSchema {
  override val columns = Array[Column](
...
object Inventory extends TcpDsSchema {
...
object StoreSales extends TcpDsSchema {
  override val columns = Array[Column](
...
object StoreReturns extends TcpDsSchema {
...
object WebSales extends TcpDsSchema {
...
object WebReturns extends TcpDsSchema {
...
object CallCenter extends TcpDsSchema {
  override val columns = Array[Column](
...
//8 tables
object CatalogPage extends TcpDsSchema {
...
object CustomerDS extends TcpDsSchema {
...
object CustomerAddress extends TcpDsSchema {
...
object CustomerDemographics extends TcpDsSchema {
...
object DateDim extends TcpDsSchema {
...
object HouseholdDemographics extends TcpDsSchema {
...
object IncomeBand extends TcpDsSchema {
...
object Item extends TcpDsSchema {
  override val columns = Array[Column](
...
//8 tables
object Promotion extends TcpDsSchema {
...
object Reason extends TcpDsSchema {
...
object ShipMode extends TcpDsSchema {
...
object Store extends TcpDsSchema {
...
object TimeDim extends TcpDsSchema {
  override val columns = Array[Column](
...
object Warehouse extends TcpDsSchema {
...
object WebPage extends TcpDsSchema {
...
object WebSite extends TcpDsSchema {
  override val columns = Array[Column](
