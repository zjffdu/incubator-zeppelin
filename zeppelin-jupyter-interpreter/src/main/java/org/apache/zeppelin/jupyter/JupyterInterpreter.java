...
/**
 * Interpreter for Jupyter kernel. It can works for any Jupyter kernel as long as the kernel
 * is installed. Specify the kernel name in paragraph properties. Run it via `%jupyter(kernel=...)`
 *
 */
