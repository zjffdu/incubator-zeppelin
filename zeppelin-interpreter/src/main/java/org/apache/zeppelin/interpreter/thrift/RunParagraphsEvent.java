    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RunParagraphsEvent struct) throws org.apache.thrift.TException {
      ...
      if (struct.paragraphIds != null) {
        oprot.writeFieldBegin(PARAGRAPH_IDS_FIELD_DESC);
        {
          ...
          for (String _iter24 : struct.paragraphIds)
          {
      ...
      if (struct.paragraphIndices != null) {
        oprot.writeFieldBegin(PARAGRAPH_INDICES_FIELD_DESC);
        {
          ...
          for (int _iter25 : struct.paragraphIndices)
          {
      ...
      if (struct.isSetParagraphIds()) {
        {
          ...
          for (String _iter26 : struct.paragraphIds)
          {
      ...
      if (struct.isSetParagraphIndices()) {
        {
          ...
          for (int _iter27 : struct.paragraphIndices)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.paragraphIds = new ArrayList<String>(_list28.size);
          String _elem29;
          for (int _i30 = 0; _i30 < _list28.size; ++_i30)
          {
            _elem29 = iprot.readString();
            struct.paragraphIds.add(_elem29);
          }
        }
        struct.setParagraphIdsIsSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          struct.paragraphIndices = new ArrayList<Integer>(_list31.size);
          int _elem32;
          for (int _i33 = 0; _i33 < _list31.size; ++_i33)
          {
            _elem32 = iprot.readI32();
            struct.paragraphIndices.add(_elem32);
          }
        }
        struct.setParagraphIndicesIsSet(true);
      }
