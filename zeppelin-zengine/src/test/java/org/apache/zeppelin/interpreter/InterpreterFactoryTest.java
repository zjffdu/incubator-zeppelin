...
public class InterpreterFactoryTest extends AbstractInterpreterTest {
  ...
  public void testGetFactory() throws IOException {
    ...
    assertTrue(interpreterFactory.getInterpreter("user1", "note1", "interpreter/test") instanceof RemoteInterpreter);
    remoteInterpreter = (RemoteInterpreter) interpreterFactory.getInterpreter("user1", "note1", "interpreter/test");
    assertEquals(EchoInterpreter.class.getName(), remoteInterpreter.getClassName());
