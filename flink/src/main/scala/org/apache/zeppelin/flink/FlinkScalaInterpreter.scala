...
//      val version = properties.getProperty("zeppelin.flink.hive.version");
//      if (version == null) {
//        throw new InterpreterException("hive version is not specified, " +
//          "please set zeppelin.flink.hive.version")
//      }
